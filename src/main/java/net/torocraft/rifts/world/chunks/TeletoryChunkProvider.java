...
public class TeletoryChunkProvider implements IChunkGenerator {
  ...
  public Chunk generateChunk(int chunkX, int chunkZ) {
    ...
    noiseBuffer = noise1
        .generateNoiseOctaves(noiseBuffer, xOffset, yOffset, zOffset, xSize, ySize, zSize, xScale,
            yScale, zScale);
  ...
  protected boolean isAir(ChunkPrimer chunkprimer, int x, int y, int z) {
    return chunkprimer.getBlockState(x, y, z) == null
        || chunkprimer.getBlockState(x, y, z) == Blocks.AIR.getDefaultState();
  }
  ...
  public void populate(int chunkX, int chunkZ) {
    ...
    net.minecraftforge.event.ForgeEventFactory
        .onChunkPopulate(true, this, this.world, this.random, chunkX, chunkZ, false);
    net.minecraftforge.event.ForgeEventFactory
        .onChunkPopulate(false, this, this.world, this.random, chunkX, chunkZ, false);
